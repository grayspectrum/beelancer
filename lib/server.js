...
config.app_port = process.env.OPENSHIFT_NODEJS_PORT || config.app_port;
config.app_host = process.env.OPENSHIFT_NODEJS_IP || config.app_host;
...
function bindRoutes(app, certs, next) {
	var routes = require('./routes.js');
	// bind routes
	routes.bind(app, config);
	next(null, app, certs);
};
